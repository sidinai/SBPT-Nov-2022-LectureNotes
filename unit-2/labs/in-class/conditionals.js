...
//     let vareven = (num / oneHundred)
//     console.log("100 divided by", num, "is", vareven);
// } else if ((num % 2) !== 0) {
//     console.log("An Odd Number:", num)
//     let varodd = (oneHundred - num)
//     console.log("100 minus", num, "is", varodd)
// }
...
// let reqBakeTimeInMins = Math.floor((Math.random() * 60) + 1);
// let actBakeTimeInMins = Math.floor((Math.random() * 60) + 1);

let reqBakeTimeInMins = 40;
let actBakeTimeInMins = 40;

actBakeTimeInMins === reqBakeTimeInMins ? console.log("Remove from oven. It is done!") :
    actBakeTimeInMins < reqBakeTimeInMins ? console.log("Still cooking...") :
...
// switch (true) {
//     case (randomNumber === 2 || randomNumber === 3 || randomNumber === 5 || randomNumber === 7):
//         value = "Prime";
//         break;
//     case (randomNumber === 4 || randomNumber === 6 || randomNumber === 8 || randomNumber === 10):
//         value = "Even";
//         break;
//     default:
//         (value = randomNumber);
