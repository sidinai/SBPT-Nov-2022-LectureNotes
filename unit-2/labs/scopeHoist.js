//! Research: Hoisting, Scope, Expressions vs. Declaration vs.
...
// * Var example: scoped to the nearest function block
let a = 12;
...
c(); // doesn't break because function c() is hoisted to the top of our code
...
// newFunction(); - if up here would break because newFunction is not hoisted
let newFunction = () => {
    console.log("hoisted?")
}
newFunction();