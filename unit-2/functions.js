...
// Given the array, create a function that lists out the values indidually
...
function order(ticket, total) {
    console.log(`I exchanged my ticket for a ${ticket}. It costs ${total} dollars`);
}

order('cheese pizze', 10);
order('soup');
order('salad');
/*
invoking - arguments
...
let tue = coffeeMaker('tea');
let wed = coffeeMaker('greent tea');
